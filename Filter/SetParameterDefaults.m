...
param.control.gpsSpdErrLim = 2.0; % GPS use will not start if reported GPS speed error is greater than this (m/s)
%Changed from default 1.0 speed error limit, which rejected too many GPS
%points (used points up from 5% to 60%)
...
param.control.flowOnTime = 10^10; % optical flow aiding will be turned back on on at this time (sec)
param.control.visoOffTime = 0; % visual odometry aiding will be turned off at this time (sec)
param.control.visoOnTime = 10^10; % visual odometry aiding will be turned back on at this time (sec)
